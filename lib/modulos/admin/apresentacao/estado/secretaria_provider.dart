...
class SecretariaService {
  ...
  Future<void> salvarSecretaria(Map<String, dynamic> dados) async {
    ...
    // 2. Salva na pasta oficial da Secretária
  ...
  Future<String?> fazerUploadFoto(String idParaSalvar, Uint8List bytesFoto, String extensao) async {
    try {
      final path = 'tenants/$tenantId/secretaria/$idParaSalvar/foto_perfil.$extensao';
...
final secretariaStreamProvider = StreamProvider<List<Map<String, dynamic>>>((ref) {
  final usuario = ref.watch(authProvider).value;
