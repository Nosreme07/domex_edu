...
class _ProfessorCalendarioTelaState extends ConsumerState<ProfessorCalendarioTela> {
      ...
      for (int dia = 1; dia <= diasNoMes; dia++) {
        ...
        if (evDia.isNotEmpty) {
           ...
           if (temFeriado) {
             ...
             corFundoCelula = PdfColor.fromHex('#FFF59D');
           }
        } else {
  ...
  // ==========================================================================
  // MODAL DE DETALHES DO DIA (LEITURA APENAS PARA PROFESSOR)
  // ==========================================================================
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Nenhum evento registrado pela direção.', style: TextStyle(color: Colors.grey.shade500)),
                  ],
                ),
              )
            : ListView.separated(
  ...
  // ==========================================================================
  Widget _buildVisaoMes(Map<String, List<Map<String, dynamic>>> eventosPorData, bool isMobile) {
        ...
        Row(
          children: _diasSemanaAbrev.map((dia) => Expanded(
            child: Container(
              ...
              child: Text(dia, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blueGrey, fontSize: isMobile ? 10 : 14)),
            ),
          )).toList(),
        ),
  ...
  Widget _buildVisaoSemana(Map<String, List<Map<String, dynamic>>> eventosPorData, bool isMobile) {
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(evento['titulo'] ?? '', style: TextStyle(fontWeight: FontWeight.bold, fontSize: isMobile ? 10 : 12, color: cor), maxLines: 2, overflow: TextOverflow.ellipsis),
                            ],
                          ),
                        ),
                      );
  ...
  Widget _buildVisaoAno(Map<String, List<Map<String, dynamic>>> eventosPorData, bool isMobile) {
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(_mesesNomes[mes].toUpperCase(), style: TextStyle(fontSize: isMobile ? 14 : 18, fontWeight: FontWeight.bold, color: isMesAtual ? Colors.blue.shade800 : Colors.blueGrey)),
