                        ...
                        _MenuItem(
                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Módulo Financeiro em breve!'),
                              ),
                            );
                          },
                        ),

                        // --- NOVO MÓDULO DO CALENDÁRIO ---
                        _MenuItem(
                          icone: Icons.event_note_rounded,
                          titulo: 'Calendário Escolar',
                          onTap: () => context.go(
                            '/admin/calendario',
                          ), // Rota para o calendário completo
                        ),
            ...
            bottomNavigationBar: isWebDesktop
                ...
                : BottomNavigationBar(
                    ...
                    onTap: (index) {
                      ...
                      if (index == 2) context.go('/admin/calendario');
                      if (index == 3) context.go('/admin/configuracoes');
                    },
                  ),
          ),
        );
